...
/*************************************/
mess = {
				wait: '*「 WAIT 」 TOUKA BOT Sedang Dalam proses*'
}
/******** OWNER NUMBER**********/
const ownerNumber = ["6282291992581@s.whatsapp.net"] 
/************************************/
...
❍█│【♡ۣۜۜ፝͜͜͡͡✿➣ *FAVORIT:*
❍█│【♡ۣۜۜ፝͜͜͡͡✿➣ *HOBBY:*
❍█│【♡ۣۜۜ፝͜͜͡͡✿➣ *KETIK #MENU UNTUK MEMULAI BOT
❍█╰━━━━━━━━━━━`
	...
	client.on('message-new', async (mek) => {
       ...
       case 'play':
               ...
               if (data.error) return reply(data.error)
                 infomp3 = `「 *PLAY* 」\n*Judul* : ${data.result.title}\n*Duration* : ${data.result.duration}\n*Filesize* : ${data.result.size}\n\n*Tunggu TOUKA BOT Sedang mengirim audio nya jangan spam*`
   ...
   if (isLimit(sender)) return reply(ind.limitend(pusname)) 
    ...
    break
                ...
                if (umurUser < 10) return reply(`your age is too young minimum 10 years`)
                veri = sender
                if (isGroup) {
           ...
           case 'demote':
			...
			if (body.startsWith(`${prefix}${command}`)) {
                  reply(`Maaf *${pushname}*, Command *${prefix}${command}* Tidak Terdaftar Di Dalam *${prefix}menu*! TOUKA BOT`)
                  }
